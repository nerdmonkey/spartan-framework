...
class FakeFileLogger:
    ...
    def log(self, message, level=None):
        self.calls["file"].append(("log", message, level))

    def info(self, message, **kwargs):
        self.calls["file"].append(("info", message, kwargs))

    def warning(self, message, **kwargs):
        self.calls["file"].append(("warning", message, kwargs))

    def error(self, message, **kwargs):
        self.calls["file"].append(("error", message, kwargs))

    def debug(self, message, **kwargs):
        self.calls["file"].append(("debug", message, kwargs))

    def exception(self, message, *args, **kwargs):
        self.calls["file"].append(("exception", message, args, kwargs))


class FakeStreamLogger:
    calls = None
    ...
    def log(self, message, level=None):
        self.calls["stream"].append(("log", message, level))

    def info(self, message, **kwargs):
        self.calls["stream"].append(("info", message))

    def warning(self, message, **kwargs):
        self.calls["stream"].append(("warning", message))

    def error(self, message, **kwargs):
        self.calls["stream"].append(("error", message))

    def debug(self, message, **kwargs):
        self.calls["stream"].append(("debug", message))

    def exception(self, message, *args, **kwargs):
        self.calls["stream"].append(("exception", message))
...
def test_prettify_extra_redacts_sensitive_fields():
...
def test_bothlogger_delegates_to_file_and_stream(monkeypatch):
    ...
    FakeFileLogger.calls = calls
    FakeStreamLogger.calls = calls
    monkeypatch.setattr(both_mod, "FileLogger", FakeFileLogger)
    monkeypatch.setattr(both_mod, "StreamLogger", FakeStreamLogger)
